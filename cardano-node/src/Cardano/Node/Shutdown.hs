...
-- external or internal, as requested by configuration in 'NodeProtocolMode',
...
withShutdownHandling
  ...
  -> (ShutdownFDs -> IO ())
  -> IO ()
withShutdownHandling npm trace action = do
...
-- | If configuration in 'NodeProtocolMode' and 'ShutdownFDs' agree,
